...
namespace Logowanie
{
    public class Logg
    {
        ...
        private void setZapisLogaDoPliku(RodzajLogowania typLog, string komunikat)
        {
            try
            {
                System.Console.WriteLine("c:\\imex\\ConnectorRaksSQL_" + DateTime.Now.Year.ToString() + "_" + DateTime.Now.Month.ToString() + "_" + DateTime.Now.Day.ToString() + ".log");
                writer = new StreamWriter(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + "\\ConnectorRaksSQL_" + DateTime.Now.Year.ToString() + "_" + DateTime.Now.Month.ToString() + "_" + DateTime.Now.Day.ToString() + ".log", true);
                //writer = new StreamWriter("c:\\imex\\ConnectorRaksSQL_" + DateTime.Now.Year.ToString() + "_" + DateTime.Now.Month.ToString() + "_" + DateTime.Now.Day.ToString() + ".log", true);
